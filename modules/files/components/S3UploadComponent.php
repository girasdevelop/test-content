 ...
 */
class S3UploadComponent extends Component implements UploadComponentInterface
{
    /**
     ...
     * @var string
     */
    public $s3AccessKeyID = 'asfdsgfdsgfd';

    /**
     * @var string
     */
    public $s3SecretAccessKey = 'safddsafdsgf';
    ...
    public function init()
    {
        ...
        $this->s3Client = new S3Client([
            ...
            'region'  => 'us-east-1',
            'credentials' => [
                'key'    => $this->s3AccessKeyID,
                'secret' => $this->s3SecretAccessKey,
            ],
        ]);
    }
